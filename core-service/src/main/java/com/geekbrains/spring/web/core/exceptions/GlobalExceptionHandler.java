...
import com.geekbrains.spring.web.api.exceptions.OrderStatusException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<AppError> catchOrderStatusException(OrderStatusException e){
        log.error(e.getMessage(), e);
        return new ResponseEntity<>(new AppError("ORDER_STATUS_IS_INCORRECT",e.getMessage()), HttpStatus.BAD_REQUEST);
    }
